...
class BusinessLocation extends Model
{
     ...
     * @return array
     */
    public static function forDropdownSell($business_id, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true, $check_permission = true)
    {
        $query = BusinessLocation::where('business_id', $business_id)->where('custom_field1',null)->Active();
