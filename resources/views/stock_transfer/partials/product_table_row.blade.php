<tr class="product_row">
    ...
    <td>
        ...
        <input type="text" class="form-control product_quantity input_number input_quantity"
            value="{{ @format_quantity($qty_ordered) }}" name="products[{{ $row_index }}][quantity]"
            ...
            @if ($product->enable_stock) data-rule-max-value="{{ $max_qty_rule }}" data-msg-max-value="{{ $max_qty_msg }}"
        ...
        <input type="hidden" class="base_unit_multiplier" name="products[{{ $row_index }}][base_unit_multiplier]"
            value="{{ $multiplier }}">
    ...
    <td>
        <input type="text" name="products[{{ $row_index }}][unit_price]"
            ...
            value="{{ @num_format($product->last_purchased_price * $multiplier) }}">
    </td>
    <td>
