        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::select('common_settings[contact_id]', [], !empty($common_settings['contact_id']) ? $common_settings['contact_id'] : null, ['class' => 'form-control', 'placeholder' => __('messages.please_select'), 'id' => 'supplier_id']) !!}
                </div>
            </div>
        </div>
    </div>
