...
<div class="watermark-container">
    <div class="row" style="color: #000000 !important; margin:0px; line-height:1.2;">
        <!-- Logo -->
    ...
    @if (!empty($receipt_details->letter_head))
        <div class="col-12 text-center">
            <img style="width: 100%;margin-bottom: 2px;" src="{{ $receipt_details->letter_head }}">
        </div>
    @endif
    ...
    <div class="col-12 text-center">
        ...
        <p style="width: 100% !important" class="word-wrap">
            <small class="pull-left text-left word-wrap">
            ...
            <small class="pull-right text-left">
            ...
            <tbody>
                @forelse($receipt_details->lines as $line)
                    <tr>
                        ...
                        <td class="text-center">{{ number_format($line['unit_price_before_discount']) }}</td>
                        @if (!empty($receipt_details->discounted_unit_price_label))
                            <td class="text-center">
                        ...
                        @endif
                        <td class="text-center">{{ number_format($line['line_total']) }}</td>
                    </tr>
...
<div class="row" style="color: #000000 !important;">
    <div class="col-md-12">
        ...
        <div class="table-responsive">
            <table class="table table-slim" style="font-size:14px;">
                <tbody>
                    ...
                    @if (!empty($receipt_details->total_exempt_uf))
                        <tr>
                            ...
                            <td class="text-right">
                                {{ number_format($receipt_details->total_exempt) }}
                            </td>
                        </tr>
                    @endif
                    <!-- Shipping Charges -->
