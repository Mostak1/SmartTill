...
<section class="content">
	...
	{!! Form::open(['url' => action([\App\Http\Controllers\StockAdjustmentController::class, 'stockSurplusStore']), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]) !!}
			...
			<div class="col-sm-8">
				<div class="form-group">
					<div class="input-group">
						...
						{!! Form::text('search_product', null, ['class' => 'form-control mousetrap', 'id' => 'search_product', 'placeholder' => __('lang_v1.search_product_placeholder'), 'disabled' => $search_disable, 'autocomplete' => 'off']); !!}
					</div>
				</div>
			</div>
			<div class="col-sm-2">
				...
				<tr>
					<td class="col-md-3">
						<div class="form-group">
							...
							{!! Form::select('discount_type', ['percentage' => __( 'lang_v1.percentage' ),'fixed' => __( 'lang_v1.fixed' ), ], '', ['class' => 'form-control select2']); !!}
						</div>
					</td>
					<td class="col-md-3">
						<div class="form-group">
						{!! Form::label('discount_amount', __( 'purchase.discount_amount' ) . ':') !!}
						{!! Form::text('discount_amount', 100, ['class' => 'form-control input_number', 'required']); !!}
						</div>
					</td>
					<td class="col-md-3">
						&nbsp;
