    ...
    $(document).ready(function() {
        ...
        $('#category_select').on('change', function() {
            ...
            if (selectedCategoryId == usCategoryId) {
                ...
                $('.dsp_label').html("@lang('product.exc_of_tax') <span style='color: red;'> USD</span>:*");
            } else {
                $('#single_dpp_label').html("{{ trans('product.exc_of_tax') }}:*");
                // $('#single_dpp_inc_tax_label').html("{{ trans('product.inc_of_tax') }}:*");
                $('.dsp_label').html("@lang('product.exc_of_tax')");
            }
        });
    });
</script>
