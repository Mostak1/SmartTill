<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action([\App\Http\Controllers\SubCategoryController::class, 'store']), 'method' => 'post', 'id' => $quick_add ? 'quick_add_brand_form' : 'brand_add_form' ]) !!}
    ...
    <div class="modal-body">
      <div class="form-group">
        {!! Form::label('name', __( 'subcategory.subcategory_name' ) . ':*') !!}
          {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'subcategory.subcategory_name' ) ]); !!}
      </div>

      <div class="form-group">
        {!! Form::label('category_id',__('subcategory.category') . ':*') !!}
        {!! Form::select('category_id', $categories, null, ['class' => 'form-control', 'required', 'placeholder' =>__('subcategory.category')]) !!}
    ...
    <div class="modal-footer">
      <button type="submit" class="btn save btn-primary">@lang( 'messages.save' )</button>
