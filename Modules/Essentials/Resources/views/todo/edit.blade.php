<div class="modal-dialog" role="document">
    <div class="modal-content">
        {!! Form::open([
            'url' => action([\Modules\Essentials\Http\Controllers\ToDoController::class, 'update'], $todo->id),
            'id' => 'task_form',
            'method' => 'put',
        ]) !!}
            ...
            <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('users[]', $users, $todo->users->pluck('id'), [
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('priority', $priorities, $todo->priority, [
                            'class' => 'form-control select2',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('status', $task_statuses, $todo->status, [
                            'class' => 'form-control select2',
                            'placeholder' => __('messages.please_select'),
                            'style' => 'width: 100%;',
                        ]) !!}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('date', @format_datetime($todo->date), [
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('end_date', !empty($todo->end_date) ? @format_datetime($todo->end_date) : '', [
                                'class' => 'form-control datepicker text-center',
                                'readonly',
                            ]) !!}
                        </div>
