<div class="modal-dialog  modal-lg" role="document">
    {!! Form::open([
        'url' => action([\Modules\Project\Http\Controllers\ProjectController::class, 'update'], $project->id),
        'id' => 'project_form',
        'method' => 'put',
    ]) !!}
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('contact_id', $customers, $project->contact_id, [
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('status', $statuses, $project->status, [
                            'class' => 'form-control select2',
                            'placeholder' => __('messages.please_select'),
                            'required',
                            'style' => 'width: 100%;',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('lead_id', $users, $project->lead_id, [
                            'class' => 'form-control select2',
                            'multiple',
                            'id' => 'lead_id',
                            'required',
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('start_date', !empty($project->start_date) ? @format_date($project->start_date) : '', [
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('end_date', !empty($project->end_date) ? @format_date($project->end_date) : '', [
                            'class' => 'form-control datepicker',
                            'readonly',
                        ]) !!}
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('user_id[]', $users, $project->members->pluck('id'), [
                            'class' => 'form-control select2',
                            'multiple',
                            'required',
                            'style' => 'width: 100%;',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('category_id[]', $categories, $project->categories->pluck('id'), [
                            'class' => 'form-control select2',
                            'multiple',
                            'style' => 'width: 100%;',
                        ]) !!}
