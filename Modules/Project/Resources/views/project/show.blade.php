            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li
                            class="
                        @if ($tab_view == 'overview') active
                        @else
                            '' @endif">
                            <a href="#project_overview" data-toggle="tab" aria-expanded="true"
                                data-url="{{ action([\Modules\Project\Http\Controllers\ProjectController::class, 'show'], [$project->id]) . '?view=overview' }}">
                        ...
                        <li
                            class="
                        @if ($tab_view == 'project_task') active
                        @else
                            '' @endif">
                        ...
                        @if (isset($project->settings['enable_notes_documents']) && $project->settings['enable_notes_documents'])
                            <li
                                class="
                            @if ($tab_view == 'documents_and_notes') active
                            @else
                                '' @endif">
                        ...
                        @if (isset($project->settings['enable_invoice']) && $project->settings['enable_invoice'] && $is_lead_or_admin)
                            <li
                                class="
                        @if ($tab_view == 'project_invoices') active
                        @else
                            '' @endif">
                        ...
                        @if ($is_lead_or_admin)
                            <li
                                class="
                        @if ($tab_view == 'project_settings') active
                        @else
                            '' @endif">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row " id="taskFilter">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::select('assigned_to_filter', $project_members, null, [
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('due_date_filter', $due_dates, null, [
                                            'class' => 'form-control select2',
                                            'placeholder' => __('messages.all'),
                                            'style' => 'width: 100%;',
                                        ]) !!}
                        ...
                        @if (isset($project->settings['enable_notes_documents']) && $project->settings['enable_notes_documents'])
                            ...
                            <input type="hidden" name="notable_type" id="notable_type"
                                value="Modules\Project\Entities\Project">
                            <div class="tab-pane document_note_body
                            @if ($tab_view == 'documents_and_notes') active
                            @else
                                '' @endif"
                                id="documents_and_notes">
                            </div>
                        @endif
