        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand"
                    href="{{ action([\Modules\Hms\Http\Controllers\HmsController::class, 'index']) }}"><i
                        class="fas fa-hotel"></i>@lang('hms::lang.hms')</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                @can('hms.manage_rooms')
                    <ul class="nav navbar-nav">
                        <li @if (request()->segment(1) == 'hms' && request()->segment(2) == 'rooms') class="active" @endif><a
                ...
                @can('hms.manage_price')
                    <ul class="nav navbar-nav">
                        <li @if (request()->segment(1) == 'hms' && request()->segment(2) == 'room' && request()->segment(3) == 'pricing') class="active" @endif><a
                                href="{{ action([Modules\Hms\Http\Controllers\RoomController::class, 'pricing']) }}">@lang('hms::lang.prices')</a>
                        </li>
                    </ul>
                @endcan
                @can('hms.view_booking')
                    <ul class="nav navbar-nav">
                        <li @if (request()->segment(1) == 'hms' && request()->segment(2) == 'bookings') class="active" @endif><a
                ...
                @can('hms.view_booking')
                    <ul class="nav navbar-nav">
                        <li @if (request()->segment(1) == 'hms' && request()->segment(2) == 'calendar') class="active" @endif><a
                ...
                @can('hms.manage_extra')
                    <ul class="nav navbar-nav">
                        <li @if (request()->segment(1) == 'hms' && request()->segment(2) == 'extras') class="active" @endif><a
                ...
                @can('hms.manage_unavailable')
                    <ul class="nav navbar-nav">
                        <li @if (request()->segment(1) == 'hms' && request()->segment(2) == 'unavailables') class="active" @endif><a
                ...
                @can('hms.manage_coupon')
                    <ul class="nav navbar-nav">
                        <li @if (request()->segment(1) == 'hms' && request()->segment(2) == 'coupons') class="active" @endif><a
                ...
                @can('hms.reports')
                <ul class="nav navbar-nav">
                    <li @if (request()->segment(1) == 'hms' && request()->segment(2) == 'reports') class="active" @endif><a
                ...
                @can('hms.manage_amenities')
                    <ul class="nav navbar-nav">
                        <li @if (request()->get('type') == 'amenities') class="active" @endif><a
                ...
                @can('hms.manage_settings')
                    <ul class="nav navbar-nav">
                        <li @if (request()->segment(1) == 'hms' && request()->segment(2) == 'settings') class="active" @endif><a
